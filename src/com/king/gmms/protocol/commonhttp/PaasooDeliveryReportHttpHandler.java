...
public class PaasooDeliveryReportHttpHandler extends HttpHandler {
	private static SystemLogger log = SystemLogger
			.getSystemLogger(PaasooDeliveryReportHttpHandler.class);	

	public PaasooDeliveryReportHttpHandler(HttpInterface hie) {
		super(hie);
	}
