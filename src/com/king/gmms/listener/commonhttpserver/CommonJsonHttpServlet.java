...
public class CommonJsonHttpServlet extends AbstractHttpServer {

	private static SystemLogger log = SystemLogger
			.getSystemLogger(CommonJsonHttpServlet.class);
	...
	public void processRequest(HttpServletRequest request,
		...
		try {
	         ...
	         */
			JxMessage  jxMessage = JSONObject.parseObject(receiveData, JxMessage.class);
	...
	public void response(GmmsMessage msg,
		...
		respContent = makeJsonResponse(msg);
		if (StringUtility.stringIsNotEmpty(respContent)) {
			respContent = "{\"msgid\":\""+msg.getInMsgID()+"\","+respContent+"}";
		}else {
			respContent = "{}";
		}
